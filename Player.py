...
class Player:
    def __init__(self):
        ...
        self.player_size = min(self.screen_size[0], self.screen_size[1]) * UI_settings.player_size_mul
    ...
    def draw(self):
        pg.draw.circle(
            self.screen, UI_settings.player_circle_color, self.player_pos_curr, self.player_size, width=5
        )
