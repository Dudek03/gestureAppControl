...
class Puck:
    def __init__(self):
        ...
        self.puck_size = min(self.screen_size[0], self.screen_size[1]) * UI_settings.puck_size_mul
    ...
    def draw(self):
        pg.draw.circle(self.screen, UI_settings.puck_color, self.puck_pos_curr, self.puck_size)
